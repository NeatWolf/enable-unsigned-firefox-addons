...
foreach ($Pattern in @('Changelog', 'Unreleased', 'safer Windows launchers', 'write access', 'repacker', 'next-step', 'PowerShell/.NET archive rebuilding', 'repository verification')) {
