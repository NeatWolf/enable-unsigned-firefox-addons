...
foreach ($Pattern in @('Changelog', 'Unreleased', 'safer Windows launchers', 'write access', 'path error', 'repacker', 'next-step', 'startupCache', 'dry-run', 'PowerShell/.NET archive rebuilding', 'repository verification')) {
